...
class LevelChangePropagatorCheckerTest {
    ...
    protected void afterEach() {
        ...
        listenerList.stream().filter(LevelChangePropagator.class::isInstance)
            .forEach(l -> {
    ...
    void testOnResetComplete(boolean bridgeIsInstalled) {
        ...
        assertEquals(bridgeIsInstalled, copyOfStatusList.stream()
                .anyMatch(s -> "Slf4j bridge handler found to be enabled. Installing the LevelChangePropagator".equals(s.getMessage())),
